...
class ComidaAdapter(private val mContext: Context, private val listaComida: MutableList<Comida>) :
    ArrayAdapter<Comida>(mContext, 0, listaComida) {
    @SuppressLint("ViewHolder")
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        val layout: View =
            LayoutInflater.from(mContext).inflate(R.layout.item_comida, parent, false)
